...
namespace pcl
{
    ...
    class CFH_Estimation_RGB_FPFH_L2 : public FeatureFromNormals<PointInT, PointNT, PointOutT>
    {
    public:
        using Ptr = shared_ptr<CFH_Estimation_RGB_FPFH_L2<PointInT, PointNT, PointOutT> >;
        using ConstPtr = shared_ptr<const CFH_Estimation_RGB_FPFH_L2<PointInT, PointNT, PointOutT> >;
        ...
        CFH_Estimation_RGB_FPFH_L2() :
            nr_bins_f1_(33),
            d_pi_(1.0f / (2.0f * static_cast<float> (M_PI)))
        {
            feature_name_ = "CFH_Estimation_RGB_FPFH_L2";
        };
