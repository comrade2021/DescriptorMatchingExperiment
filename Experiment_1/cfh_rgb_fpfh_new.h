...
namespace pcl
{
    ...
    class CFH_Estimation_RGB_FPFH_NEW : public FeatureFromNormals<PointInT, PointNT, PointOutT>
    {
    public:
        using Ptr = shared_ptr<CFH_Estimation_RGB_FPFH_NEW<PointInT, PointNT, PointOutT> >;
        using ConstPtr = shared_ptr<const CFH_Estimation_RGB_FPFH_NEW<PointInT, PointNT, PointOutT> >;
        ...
        CFH_Estimation_RGB_FPFH_NEW() :
            nr_bins_f1_(11), nr_bins_f2_(11), nr_bins_f3_(11),
            d_pi_(1.0f / (2.0f * static_cast<float> (M_PI)))
        {
            feature_name_ = "CFH_Estimation_RGB_FPFH_NEW";
        };
