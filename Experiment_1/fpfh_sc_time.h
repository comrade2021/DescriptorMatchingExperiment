...
namespace pcl
{
    ...
    class FPFH_SC_TIME_Estimation : public FeatureFromNormals<PointInT, PointNT, PointOutT>
    {
    public:
        using Ptr = shared_ptr<FPFH_SC_TIME_Estimation<PointInT, PointNT, PointOutT> >;
        using ConstPtr = shared_ptr<const FPFH_SC_TIME_Estimation<PointInT, PointNT, PointOutT> >;
        ...
        FPFH_SC_TIME_Estimation() :
            nr_bins_f1_(11), nr_bins_f2_(11), nr_bins_f3_(11),
            d_pi_(1.0f / (2.0f * static_cast<float> (M_PI)))
        {
            feature_name_ = "FPFH_SC_TIME_Estimation";
        };
        ...
        bool
            computeTimePairFeatures(const Eigen::Vector4f& p1, const Eigen::Vector4f& n1,
