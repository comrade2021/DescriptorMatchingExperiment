...
namespace pcl
{
    ...
    class CFH_Estimation_HSV_FPFH_RATE : public FeatureFromNormals<PointInT, PointNT, PointOutT>
    {
    public:
        using Ptr = shared_ptr<CFH_Estimation_HSV_FPFH_RATE<PointInT, PointNT, PointOutT> >;
        using ConstPtr = shared_ptr<const CFH_Estimation_HSV_FPFH_RATE<PointInT, PointNT, PointOutT> >;
        ...
        CFH_Estimation_HSV_FPFH_RATE() :
            nr_bins_f1_(11), nr_bins_f2_(11), nr_bins_f3_(11),
            d_pi_(1.0f / (2.0f * static_cast<float> (M_PI)))
        {
            feature_name_ = "CFH_Estimation_HSV_FPFH_RATE";
        };
