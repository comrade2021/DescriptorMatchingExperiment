...
inline bool pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::computePairFeatures(const pcl::PointCloud<PointInT>& cloud, int p_idx, int q_idx, float& f1)
{
    ...
    float L22 = sqrt((r11 - r22) * (r11 - r22) + (g11 - g22) * (g11 - g22) + (b11 - b22) * (b11 - b22));

    float odist = L22 / static_cast<float>(sqrt(3) * 100);//范围：0 - 1
...
//////////////////////////////////////////////////////////////////////////////////////////////
template<typename PointInT, typename PointNT, typename PointOutT>
inline bool pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::computeRGBPairFeatures(const Eigen::Vector4f& colors1, const Eigen::Vector4f& colors2, float& f1)
{
    return (true);
}
...
template<typename PointInT, typename PointNT, typename PointOutT>
std::array<float, 256>
pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::sRGB_LUT = pcl::RGB2sRGB_LUT<float, 8>();

//////////////////////////////////////////////////////////////////////////////////////////////
template<typename PointInT, typename PointNT, typename PointOutT>
std::array<float, 4000>
pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::sXYZ_LUT = pcl::XYZ2LAB_LUT<float, 4000>();

template<typename PointInT, typename PointNT, typename PointOutT>
inline void pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::RGB2CIELAB(unsigned char R, unsigned char G, unsigned char B, float& L, float& A, float& B2)
{
    float fr = sRGB_LUT[R];
    float fg = sRGB_LUT[G];
    float fb = sRGB_LUT[B];
...
pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::computePointSPFHSignature(const pcl::PointCloud<PointInT>& cloud, pcl::index_t p_idx, int row, const pcl::Indices& indices, Eigen::MatrixXf& hist_f1)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointNT, typename PointOutT> void
pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::weightPointSPFHSignature(
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointNT, typename PointOutT> void
pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::computeSPFHSignatures(std::vector<int>& spfh_hist_lookup,
...
//////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointInT, typename PointNT, typename PointOutT> void
pcl::CFH_Estimation_LAB_FPFH_L2<PointInT, PointNT, PointOutT>::computeFeature(PointCloudOut& output)
{
    // Allocate enough space to hold the NN search results
    // \note This resize is irrelevant for a radiusSearch ().
    pcl::Indices nn_indices(k_);
